...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self):
    ...
    self._AWARENESS_TIME = 309999999. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 15.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 6.
    self._DISTRACTED_TIME = 11999999999. # active monitoring total timeout
    ...
    self._MAX_TERMINAL_ALERTS = 39999  # not allowed to engage after 3 terminal alerts
